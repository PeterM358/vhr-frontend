/**
 * Web screen imports — all eager to avoid Metro async chunk module ID mismatches.
 * (output: "single" still emits lazy chunks that fail at runtime with "unknown module".)
 */
