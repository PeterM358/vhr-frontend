...
export function partnerOrganizationOperations(params = {}) {
...
export function partnerOrganizationTasks(params = {}) {
  return buildPathWithQuery(`${PARTNER}/organization/tasks`, params);
}

export function partnerOrganizationProjects(params = {}) {
  return buildPathWithQuery(`${PARTNER}/organization/projects`, params);
}

export function partnerOrganizationWarehouse(params = {}) {
...
export function partnerOrganizationFleetPlanning(params = {}) {
  return buildPathWithQuery(`${PARTNER}/organization/fleet-planning`, params);
}
...
export function partnerOrganizationActivities(params = {}) {
  return buildPathWithQuery(`${PARTNER}/organization/activities`, params);
}
