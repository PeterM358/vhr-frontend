...
export default function CompactLanguageSelector({
  ...
  const isPortalDropdown = presentation === 'portalDropdown';
  ...
  const recomputeDropdownLayout = useCallback(() => {
    if (!rootRef.current || Platform.OS !== 'web' || typeof document === 'undefined') return;
  ...
  }, [open, isPortalDropdown, recomputeDropdownLayout]);
  ...
  const shouldRenderInlineDropdown = !isModal && open && !isPortalDropdown;
  const shouldRenderPortalDropdown =
    !isModal &&
    open &&
    isPortalDropdown &&
    Platform.OS === 'web' &&
  ...
  const portalDropdown =
    shouldRenderPortalDropdown && dropdownLayout
          ...
          <View
            ...
            style={[
              styles.portalDropdown,
              {
                ...
                top: dropdownLayout.bottom + (showFullLabel ? 10 : 6),
                left: showFullLabel
                  ? dropdownLayout.left + dropdownLayout.width / 2 - dropdownWidth / 2
                  : dropdownLayout.left,
              },
            ]}
          >
