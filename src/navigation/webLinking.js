...
export function getPartnerNavigationStateFromPath(path) {
  ...
  if (pathPart === 'partner/organization/workforce') {
    const params = {};
      ...
      routes: [
        {
          ...
          state: {
            ...
            routes: [
              { name: 'OrgOverview' },
              { name: 'OrgWorkforce', params: Object.keys(params).length ? params : undefined },
            ],
          },
        },
      ],
  ...
  if (pathPart === 'partner/organization/tasks/new') {
    const params = {};
    const organizationId = parseOrganizationIdFromQuery(query);
    if (organizationId) {
      params.organizationId = organizationId;
      ...
      routes: [
        {
          ...
          state: {
            ...
            routes: [
              { name: 'OrgOverview' },
              { name: 'OrgCreateTask', params: Object.keys(params).length ? params : undefined },
            ],
          },
        },
      ],
  ...
  if (pathPart === 'partner/organization/projects' || pathPart === 'partner/organization/projects/') {
    const params = {};
    const organizationId = parseOrganizationIdFromQuery(query);
    if (organizationId) {
      params.organizationId = organizationId;
      ...
      routes: [
        {
          ...
          state: {
            ...
            routes: [
              { name: 'OrgOverview' },
              { name: 'OrgProjects', params: Object.keys(params).length ? params : undefined },
            ],
          },
        },
      ],
      ...
      routes: [
        {
          ...
          state: {
            ...
            routes: [
              { name: 'OrgOverview' },
              { name: 'OrgInvoicing', params: Object.keys(params).length ? params : undefined },
            ],
          },
        },
      ],
