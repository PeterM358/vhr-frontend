...
import {
  ...
  partnerOrganizationActivities,
  partnerOrganizationPublicProfile,
  partnerOrganizationCompanyAccount,
...
export function navigateToOrgOperations(navigation, params = {}) {
  const routeParams = params.orgId != null ? { organizationId: params.orgId, ...params } : params;
  const orgOperationsRoute = {
    name: 'OrgHome',
    state: {
      index: 1,
      routes: [
        { name: 'OrgOverview' },
        { name: 'OrgOperations', params: Object.keys(routeParams).length ? routeParams : undefined },
      ],
    },
  };
  if (Platform.OS === 'web') {
    ...
    resetPartnerStackWebRoutes(
      navigation,
      [orgOperationsRoute],
      partnerOrganizationOperations(pathParams),
    );
    return;
  }
  navigation.navigate('OrgHome', { screen: 'OrgOperations', params: routeParams });
}

export function navigateToOrgCreateTask(navigation, params = {}) {
  const routeParams = params.orgId != null ? { organizationId: params.orgId, ...params } : params;
  const orgCreateTaskRoute = {
    name: 'OrgHome',
    state: {
      index: 1,
      routes: [
        { name: 'OrgOverview' },
        { name: 'OrgCreateTask', params: Object.keys(routeParams).length ? routeParams : undefined },
      ],
    },
  };
  if (Platform.OS === 'web') {
    ...
    resetPartnerStackWebRoutes(
      navigation,
      [orgCreateTaskRoute],
      partnerOrganizationCreateTask(pathParams),
    );
    return;
  }
...
export function navigateToOrgProjects(navigation, params = {}) {
  const routeParams = params.orgId != null ? { organizationId: params.orgId, ...params } : params;
  const orgProjectsRoute = {
    name: 'OrgHome',
    state: {
      index: 1,
      routes: [
        { name: 'OrgOverview' },
        { name: 'OrgProjects', params: Object.keys(routeParams).length ? routeParams : undefined },
      ],
    },
  };
  if (Platform.OS === 'web') {
    ...
    resetPartnerStackWebRoutes(
      navigation,
      [orgProjectsRoute],
      partnerOrganizationProjects(pathParams),
    );
    return;
  }
  navigation.navigate('OrgHome', { screen: 'OrgProjects', params: routeParams });
}

export function navigateToOrgWarehouse(navigation, params = {}) {
  const routeParams = params.orgId != null ? { organizationId: params.orgId, ...params } : params;
  const orgWarehouseRoute = {
    name: 'OrgHome',
    state: {
      index: 1,
      routes: [
        { name: 'OrgOverview' },
        { name: 'OrgWarehouse', params: Object.keys(routeParams).length ? routeParams : undefined },
      ],
    },
  };
  if (Platform.OS === 'web') {
    ...
    resetPartnerStackWebRoutes(
      navigation,
      [orgWarehouseRoute],
      partnerOrganizationWarehouse(pathParams),
    );
    return;
  }
...
export function navigateToOrgWarehouseZone(navigation, params = {}) {
  const organizationId = params.orgId ?? params.organizationId;
  const locationId = params.locationId;
  const zone = params.zone;
  if (locationId == null || zone == null || zone === '') return;
  const detailParams = {
    locationId,
    zone: String(zone),
    ...(organizationId != null ? { organizationId } : {}),
  ...
  const warehouseRoute = orgWarehouseStackRoute(organizationId, 'list');
  if (Platform.OS === 'web') {
    const pathParams = { zone: String(zone) };
    if (organizationId != null) pathParams.organizationId = organizationId;
    resetPartnerStackWebRoutes(
      navigation,
      [
        warehouseRoute,
        {
          ...
          params: { locationId, ...(organizationId != null ? { organizationId } : {}) },
        },
        { name: 'OrgWarehouseZoneDetail', params: detailParams },
      ],
      partnerOrganizationWarehouseZone(locationId, String(zone), {
        organizationId,
      }),
    );
    return;
  }
  navigation.navigate('OrgWarehouseZoneDetail', detailParams);
}

export function navigateToOrgWarehouseAddress(navigation, params = {}) {
  const organizationId = params.orgId ?? params.organizationId;
  const locationId = params.locationId;
  if (locationId == null) return;
  const detailParams = {
    ...
    ...(params.zone ? { zone: String(params.zone) } : {}),
  };
  const warehouseRoute = orgWarehouseStackRoute(organizationId, 'list');
  if (Platform.OS === 'web') {
    const pathParams = {};
    if (organizationId != null) pathParams.organizationId = organizationId;
    if (params.siteId != null) pathParams.siteId = params.siteId;
    if (params.zone) pathParams.zone = String(params.zone);
    const stack = [warehouseRoute];
    ...
    stack.push({ name: 'OrgWarehouseAddressDetail', params: detailParams });
    resetPartnerStackWebRoutes(
      navigation,
      stack,
      partnerOrganizationWarehouseAddress(locationId, pathParams),
    );
    return;
  }
  navigation.navigate('OrgWarehouseAddressDetail', detailParams);
}

export function navigateToOrgAccounting(navigation, params = {}) {
  const routeParams = params.orgId != null ? { organizationId: params.orgId, ...params } : params;
  const orgAccountingRoute = {
    name: 'OrgHome',
    state: {
      index: 1,
      routes: [
        { name: 'OrgOverview' },
        { name: 'OrgAccounting', params: Object.keys(routeParams).length ? routeParams : undefined },
      ],
    },
  };
  if (Platform.OS === 'web') {
    ...
    resetPartnerStackWebRoutes(
      navigation,
      [orgAccountingRoute],
      partnerOrganizationAccounting(pathParams),
    );
    return;
  }
  navigation.navigate('OrgHome', { screen: 'OrgAccounting', params: routeParams });
}

export function navigateToOrgFleetPlanning(navigation, params = {}) {
  const routeParams = params.orgId != null ? { organizationId: params.orgId, ...params } : params;
  const orgPlanningRoute = {
    name: 'OrgHome',
    state: {
      index: 1,
      routes: [
        { name: 'OrgOverview' },
        { name: 'OrgFleetPlanning', params: Object.keys(routeParams).length ? routeParams : undefined },
      ],
    },
  };
  if (Platform.OS === 'web') {
    ...
    if (params.month) pathParams.month = params.month;
    resetPartnerStackWebRoutes(
      navigation,
      [orgPlanningRoute],
      partnerOrganizationFleetPlanning(pathParams),
    );
    return;
  }
  navigation.navigate('OrgHome', { screen: 'OrgFleetPlanning', params: routeParams });
}

export function navigateToOrgInvoicing(navigation, params = {}) {
  const routeParams = params.orgId != null ? { organizationId: params.orgId, ...params } : params;
  const orgInvoicingRoute = {
    name: 'OrgHome',
    state: {
      index: 1,
      routes: [
        { name: 'OrgOverview' },
        { name: 'OrgInvoicing', params: Object.keys(routeParams).length ? routeParams : undefined },
      ],
    },
  };
  if (Platform.OS === 'web') {
    ...
    resetPartnerStackWebRoutes(
      navigation,
      [orgInvoicingRoute],
      partnerOrganizationInvoicing(pathParams),
    );
    return;
  }
  navigation.navigate('OrgHome', { screen: 'OrgInvoicing', params: routeParams });
}
...
export function navigateToOrgActivities(navigation, params = {}) {
  const routeParams = params.orgId != null ? { organizationId: params.orgId, ...params } : params;
  const orgActivitiesRoute = {
    name: 'OrgHome',
    state: {
      index: 1,
      routes: [
        { name: 'OrgOverview' },
        { name: 'OrgActivities', params: Object.keys(routeParams).length ? routeParams : undefined },
      ],
    },
  };
  if (Platform.OS === 'web') {
    ...
    resetPartnerStackWebRoutes(
      navigation,
      [orgActivitiesRoute],
      partnerOrganizationActivities(pathParams),
    );
    return;
  }
  navigation.navigate('OrgHome', { screen: 'OrgActivities', params: routeParams });
}

export function navigateToOrgPublicProfile(navigation, params = {}) {
  const routeParams = params.orgId != null ? { organizationId: params.orgId, ...params } : params;
  const orgPublicRoute = {
    name: 'OrgHome',
    state: {
      index: 1,
      routes: [
        { name: 'OrgOverview' },
        { name: 'OrgPublicProfile', params: Object.keys(routeParams).length ? routeParams : undefined },
      ],
    },
  };
  if (Platform.OS === 'web') {
    ...
    resetPartnerStackWebRoutes(
      navigation,
      [orgPublicRoute],
      partnerOrganizationPublicProfile(pathParams),
    );
    return;
  }
  navigation.navigate('OrgHome', { screen: 'OrgPublicProfile', params: routeParams });
}

export function navigateToOrgCompanyAccount(navigation, params = {}) {
  const routeParams = params.orgId != null ? { organizationId: params.orgId, ...params } : { ...params };
  if (params.tab) routeParams.tab = params.tab;
  const orgAccountRoute = {
    name: 'OrgHome',
    state: {
      index: 1,
      routes: [
  ...
  if (Platform.OS === 'web') {
    ...
    resetPartnerStackWebRoutes(
      navigation,
      [orgAccountRoute],
      partnerOrganizationCompanyAccount(pathParams),
    );
    return;
  }
  navigation.navigate('OrgHome', { screen: 'OrgCompanyAccount', params: routeParams });
}
